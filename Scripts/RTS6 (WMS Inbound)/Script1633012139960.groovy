...
WebUI.selectOptionByValue(findTestObject('Object Repository/Page_Maven by Glaucus/select_Select WarehouseTest SKU Warehouse'), 
    'object:56', true)
...
WebUI.setText(findTestObject('Object Repository/Page_Maven by Glaucus/input_Unloading_search'), 'GATEP0000001304')
...
WebUI.setText(findTestObject('Object Repository/Page_Maven by Glaucus/input__POList_value'), '2SKUTest2')

WebUI.click(findTestObject('Object Repository/Page_Maven by Glaucus/div_selectPO'))

WebUI.setText(findTestObject('Object Repository/Page_Maven by Glaucus/input_External Ref No_POInputField'), 'Ext_2SKUTest2')

WebUI.setText(findTestObject('Object Repository/Page_Maven by Glaucus/input__LrNumber'), 'LR_2SKUTest2')

WebUI.setText(findTestObject('Object Repository/Page_Maven by Glaucus/input__InvoiceNumber'), 'Inv_2SKUTest2')

WebUI.setText(findTestObject('Object Repository/Page_Maven by Glaucus/input_EWB Number_ewbNumber'), 'Ewb_2SKUTest2')
...
WebUI.setText(findTestObject('Object Repository/Page_Maven by Glaucus/input_Validation_search'), 'GATEP0000001304')
...
WebUI.sendKeys(findTestObject('Object Repository/Page_Maven by Glaucus/input_DocGrossPrice1'), '10000.00')

Thread.sleep(2000)

WebUI.sendKeys(findTestObject('Object Repository/Page_Maven by Glaucus/input_DocGrossPrice2'), '20000.00')

WebUI.click(findTestObject('Object Repository/Page_Maven by Glaucus/icon_DeleteDocCharges'))
...
WebUI.setText(findTestObject('Object Repository/Page_Maven by Glaucus/input_QC_search'), 'GATEP0000001304')
...
WebUI.setText(findTestObject('Object Repository/Page_Maven by Glaucus/input_Bin_bin'), 'BINOW00049992')

for (int a = 1; a<= 10; a++ )
{
WebUI.setText(findTestObject('Object Repository/Page_Maven by Glaucus/input_SKU_SKU'), 'nike1')
Thread.sleep(1500)
}

for (int a = 1; a<= 10; a++ )
{
WebUI.setText(findTestObject('Object Repository/Page_Maven by Glaucus/input_SKU_SKU'), 'nike2')
Thread.sleep(1500)
}
...
WebUI.setText(findTestObject('Object Repository/Page_Maven by Glaucus/input_From Bin_putawayFromBinInput'), 'BINOW00049992')

WebUI.setText(findTestObject('Object Repository/Page_Maven by Glaucus/input_To Bin_putawayToBinInput'), 'BINOW00049992')
