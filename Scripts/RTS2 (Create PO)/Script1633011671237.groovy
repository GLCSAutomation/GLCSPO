...
WebUI.setText(findTestObject('Object Repository/Page_Maven by Glaucus/input_Ref. No_OrderNo'), 'RegTest3')
...
WebUI.setText(findTestObject('Object Repository/Page_Maven by Glaucus/input__tableSkuName'), 'SKUALL')
